...
def awsConsoleAuthSmoker():
    ...
    headers = {
        ...
        "Referer": "https://signin.aws.amazon.com/oauth?redirect_uri=https%3A%2F%2Fconsole.aws.amazon.com%2Fconsole%2Fhome%3Fstate%3DhashArgs%2523%26isauthcode%3Dtrue&client_id=arn%3Aaws%3Aiam%3A%3A"
        + account_id
        + "%3Auser%2Fhomepage&response_type=code&iam_user=true&account="
        + account_id,
    }
    data = {
    ...
    logger.info(
        iso_now_time + " testing user: droid-testing into " + account_id + " account"
    )
    time.sleep(5)
